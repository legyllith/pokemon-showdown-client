...
export const BattleMoveAnims: AnimTable = {
	...
	burningterrain: {
		anim(scene, [attacker]) {
			scene.backgroundEffect('#FC6A21', 1000, 0.3);
			BattleOtherAnims.dance.anim(scene, [attacker]);
		},
	},
	desertterrain: {
	...
	caveterrain: {
		anim(scene, [attacker]) {
			scene.backgroundEffect('#482E02', 1000, 0.3);
			BattleOtherAnims.dance.anim(scene, [attacker]);
		},
	},
	poisonmistterrain: {
		anim(scene, [attacker]) {
			scene.backgroundEffect('#630B5D', 1000, 0.3);
			BattleOtherAnims.dance.anim(scene, [attacker]);
		},
	},
	submarineterrain: {
		anim(scene, [attacker]) {
			scene.backgroundEffect('#164968', 1000, 0.3);
			BattleOtherAnims.dance.anim(scene, [attacker]);
		},
	},
	icecaveterrain: {
		anim(scene, [attacker]) {
			scene.backgroundEffect('#1174B1', 1000, 0.3);
			BattleOtherAnims.dance.anim(scene, [attacker]);
		},
	},
	...
	pokerface: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#390000 30%, #7A38B8)', 600, 0.6, 400);
			scene.showEffect('angry', {
				x: attacker.x - 10,
				y: attacker.y + 50,
				z: attacker.z,
...
BattleMoveAnims['insectswarm'] = {anim: BattleMoveAnims['megahorn'].anim};
